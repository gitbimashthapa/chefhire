  ...
  return (
    <header
      className={cn(
        ...
        scrolled ? "bg-blue shadow-md backdrop-blur-sm" : "bg-transparent"
      )}
    >
      <div className="container flex justify-between items-center mx-auto">
        ...
        <nav className="hidden md:flex items-center space-x-8">
          <Link
            to="/"
            className="text-foreground hover:text-chef-accent transition-colors"
          >
            Home
          </Link>
          <button
      ...
      {isMenuOpen && (
        <div className="md:hidden absolute top-full left-0 right-0 glass mt-2 py-4 px-6 animate-slideUp">
          <nav className="flex flex-col space-y-4">
            <Link
              to="/"
              className="text-foreground hover:text-chef-accent transition-colors py-2"
            >
              Home
            </Link>
            <button
