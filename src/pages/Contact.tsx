    ...
    <Layout>
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
          <div className="bg-white rounded-xl shadow-sm p-8 animate-slideInLeft">
          ...
          <div className="bg-white rounded-xl shadow-sm p-8 animate-slideUp">
            ...
            <div className="space-y-8">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="mailto:info@chefhire.com" className="text-chef-accent hover:underline">
                    info@chefhire.com
                  </a>
                  <p className="text-muted-foreground mb-1 mt-2">Support:</p>
                  <a href="mailto:support@chefhire.com" className="text-chef-accent hover:underline">
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <a href="tel:+15551234567" className="text-chef-accent hover:underline">
                    +1 (555) 123-4567
                  </a>
                  <p className="text-muted-foreground mb-1 mt-2">Hours of Operation:</p>
