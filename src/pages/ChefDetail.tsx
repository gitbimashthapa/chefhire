      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <div className="bg-blue rounded-lg shadow-md overflow-hidden">
              <div className="aspect-[3/2] relative">
                ...
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex flex-col justify-end p-6 text-blue">
              ...
              <div className="p-6">
                ...
                <div>
                  ...
                  <ul className="list-disc pl-5 mb-6 space-y-1 text-muted-foreground">
                    <li>
                      Professional culinary training from top culinary school
                    </li>
                    <li>
                      Specializes in {chef.speciality} with a modern twist
                    </li>
                    <li>
                      Experience in high-end restaurants and private events
                    </li>
          ...
          {/* Booking Panel */}
          <div>
            <div className="bg-blue rounded-lg shadow-md p-6 sticky top-24">
                    ...
                    {timeSlots.map((slot) => (
                      <button
                        ...
                        className={`
                          ...
                          RS{selectedTimeSlot?.id === slot.id 
